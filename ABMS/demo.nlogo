...
to setup-cows
  create-cows initial-cows [
    setxy random-xcor random-ycor
    set color white
    set hungry-counter 5
    set energy initial-cow-energy
  ]
end
...
to eat-cows
  if any? cows-here [
    let target one-of cows-here
    ask target [ die ]
    set energy energy + energy-gain-from-cow
  ]
end
...
"grass" 1.0 0 -13840069 true "" "plot (sum [grass-amount] of patches) / 10"
"pen-2" 1.0 0 -8431303 true "" "plot (count wolves) * 10"
